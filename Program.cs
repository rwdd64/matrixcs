namespace Matrix
{
    class Program
    {
        static void Matrix(ConsoleColor color=ConsoleColor.Green)
        {
            // Limpar a tela
            Console.Clear();

            // Setar a cor do texto
            // Se não for especificada ao chamar a função, será verde.
            // Caso contrário, será a cor especificada
            ...
            Matrix(color); // Repetir tudo denovo
        }
